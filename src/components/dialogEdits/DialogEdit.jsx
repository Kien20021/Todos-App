...
export const DialogEdit = ({ isOpen, setIsOpen, item }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 rounded-lg">
      <div className="bg-seashell p-6 rounded-lg shadow-lg lg:w-96 md:w-48 ">
        ...
        <input
          type="text"
          className="mt-4 rounded-lg lg:w-full md:w-10/12  border-inherit font-light focus:border  focus:border-seashell focus:ring-0  focus:outline-none"
